---
name: "Missing idempotency on job submission"
about: "Autter Sandbox challenge"
title: "Missing idempotency on job submission"
labels: ["autter-sandbox", "reliability"]
---

# Challenge: Missing idempotency on job submission
...
## Problem
Duplicate submission requests create duplicate jobs.
...
Fix the issue where duplicate submission requests create duplicate jobs.
