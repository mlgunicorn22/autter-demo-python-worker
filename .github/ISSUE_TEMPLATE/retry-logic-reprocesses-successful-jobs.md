---
name: "Retry logic reprocesses successful jobs"
about: "Autter Sandbox challenge"
title: "Retry logic reprocesses successful jobs"
labels: ["autter-sandbox", "reliability"]
---

# Challenge: Retry logic reprocesses successful jobs
...
## Problem
A completed job can still be retried after a worker restart.
...
Fix the issue where a completed job can still be retried after a worker restart.
...
* idempotency and state transition risk
