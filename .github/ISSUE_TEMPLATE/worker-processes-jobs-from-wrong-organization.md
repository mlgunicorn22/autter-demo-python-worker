---
name: "Worker processes jobs from wrong organization"
about: "Autter Sandbox challenge"
title: "Worker processes jobs from wrong organization"
labels: ["autter-sandbox", "authorization"]
---

# Challenge: Worker processes jobs from wrong organization
...
## Problem
Org scoping is missing in job fetch logic.
...
Fix the issue where org scoping is missing in job fetch logic.
