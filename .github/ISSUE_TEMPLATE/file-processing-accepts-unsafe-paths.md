---
name: "File processing accepts unsafe paths"
about: "Autter Sandbox challenge"
title: "File processing accepts unsafe paths"
labels: ["autter-sandbox", "security"]
---

# Challenge: File processing accepts unsafe paths
...
## Problem
The file processor can read outside the intended upload directory.
...
Fix the issue where the file processor can read outside the intended upload directory.
